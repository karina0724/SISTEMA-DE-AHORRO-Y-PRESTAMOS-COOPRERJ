...
<table width="100%">
	<tr>
		<th class="text-center" width="33.33%">Importe total a pagar</th>
		<th class="text-center" width="33.33%">Monto a pagar mensual</th>
		<th class="text-center" width="33.33%">Monto de la multa</th>
	</tr>
	<tr>
