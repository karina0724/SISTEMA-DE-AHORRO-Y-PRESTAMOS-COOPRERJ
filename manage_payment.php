...
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT * FROM payments where id=".$_GET['id']);// loan_id=".$_GET['id']);
			...
			<div class="row">
				<div class="col-md-4">
					<div class="form-group">
						<label for="" class="control-label">Número de referencia del préstamo.</label>
	...
	function load_fields(){
	 ...
	 $('#manage-payment').submit(function(e){
	 	...
	 	$.ajax({
	 		...
	 		success:function(resp){
	 			if(resp == 1){
	 				alert_toast("Los datos de pago se guardaron correctamente.","success");
